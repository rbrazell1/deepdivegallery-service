...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  @Value("${spring.security.oauth2.resourceserver.jew.issuer-uri}")
  private String issuerUri;

  @Value("${spring.security.oauth2.resourceserver.jew.client-id}")
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
        ...
        .oauth2ResourceServer().jwt().jwtAuthenticationConverter(userService);
  }
